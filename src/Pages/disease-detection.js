          ...
          <Col xs={12} md={10} lg={8} xl={10}>
            <div className="border p-4">
              <div className="mb-4 d-flex">
                ...
                <div className="flex-grow-1 d-flex justify-content-center align-items-center border rounded overflow-hidden" style={{ width: '900px', height: '100px', marginRight: "30px" }}>
                ...
                <div className="flex-grow-1">
                  <div>
                    ...
                    <p>
                      <h6>Symptoms</h6> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod 
              ...
              <div className="d-flex">
                <div className="flex-grow-1">
                  ...
                  <div>
                    ...
                    <p>
                    <h6>Organic Control</h6>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod 
                      tempor incididunt ut labore et dolore magna aliqua. Blandit volutpat maecenas 
                      volutpat blandit aliquam etiam. Gravida arcu ac tortor dignissim convallis aenean et.
                      Nullam ac tortor vitae purus. Scelerisque felis imperdiet proin fermentum leo vel. Nam at
                      lectus urna duis convallis convallis tellus. Nisl vel pretium lectus quam id leo in vitae turpis. 
                    ...
                    <p>
                    <h6>Chemical Control</h6>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod 
                      tempor incididunt ut labore et dolore magna aliqua. Blandit volutpat maecenas 
                      volutpat blandit aliquam etiam. Gravida arcu ac tortor dignissim convallis aenean et.
                      Nullam ac tortor vitae purus. Scelerisque felis imperdiet proin fermentum leo vel. Nam at
                      lectus urna duis convallis convallis tellus. Nisl vel pretium lectus quam id leo in vitae turpis. 
